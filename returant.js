let foods = [
    ...
    { type: 'فرنگی', src: './imges/farangi/chines mix.jpg', name: 'چاینیز میکس', price: 455000, },
    { type: 'فرنگی', src: './imges/farangi/chiken parmejan.jpg', name: 'پارمژان مرغ', price: 415000, },
    { type: 'فرنگی', src: './imges/farangi/chiken roll.jpg', name: 'چیکن رول', price: 400000, },
    { type: 'فرنگی', src: './imges/farangi/chiken skalp.jpg', name: 'اسکالپ مرغ', price: 397000, },
    ...
    { type: 'گریل', src: './imges/grill/grill mix.jpg', name: 'گریل میکس', price: 700000, },
    ...
    { type: 'نوشیدنی', src: './imges/drinks/dough.jpg', name: 'دوغ لیوانی', price: 40000, },
    { type: 'نوشیدنی', src: "./imges/drinks/fresh drinks.jpg", name: 'اب میوه طبیعی', price: 80000, },
    { type: 'نوشیدنی', src: './imges/drinks/delester.jpg', name: 'دلستر', price: 25000, },
]
...
let zeroTax = document.getElementById('zeroTax')
let zeroTotal = document.getElementById('zeroTotal')
let mybasket = []
